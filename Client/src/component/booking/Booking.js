...
const Booking = () => {
    ...
    useEffect(() => {
        ...
        setHotelId(JSON.parse(localStorage.getItem("hotelid")) || "");
        setLocationAddress(JSON.parse(localStorage.getItem("hoteladdress")))
        console.log("Booking componenet me locaal storage se get krne ke baad location name  :" + localStorage.getItem("hoteladdress"));
    ...
    const handleSubmit = async (e) => {
        console.log(locationaddress, "location address");
